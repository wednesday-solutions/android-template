...
class WeatherAdapter(val context: Context, var weatherDataSource: MutableList<Weather>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.minTemp.text = context.resources.getString(
            R.string.min_temp,
            weather.consolidatedWeathers[0].minTemp.roundToInt()
        )
        holder.maxTemp.text = context.resources.getString(
            R.string.max_temp,
            weather.consolidatedWeathers[0].maxTemp.roundToInt()
        )
        holder.weatherImage.setImageResource(
            weather.consolidatedWeathers[0].weatherConditionImageResourceId
        )
    }
